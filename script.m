#Criando os pontos iniciais do cubo
px = [1, 3, 1, 3, 1, 3, 1, 3];
py = [0, 0, 2, 2, 0, 0, 2, 2];
pz = [3, 3, 3, 3, 1, 1, 1, 1];

#Criado a primeira face
f1x = [1, 3, 3, 3, 3, 1, 1, 1];
f1y = [0, 0, 0, 2, 2, 2, 2, 0];
f1z = [3, 3, 3, 3, 3, 3, 3, 3];

#Criado a segunda face
f2x = [3, 3, 3, 3, 3, 3, 3, 3];
f2y = [0, 0, 0, 2, 2, 2, 2, 0];
f2z = [3, 1, 1, 1, 1, 3, 3, 3];

#Criado a terceira face
f3x = [3, 1, 1, 1, 1, 3, 3, 3];
f3y = [2, 2, 2, 2, 2, 2, 2, 2];
f3z = [3, 3, 3, 1, 1, 1, 1, 3];

#Criando a quarda face
f4x = [1, 1, 1, 1, 1, 1, 1, 1];
f4y = [0, 0, 0, 2, 2, 2, 2, 0];
f4z = [3, 1, 1, 1, 1, 3, 3, 3];

#Criando a quinta face
f5x = [1, 3, 3, 3, 3, 1, 1, 1];
f5y = [0, 0, 0, 0, 0, 0, 0, 0];
f5z = [3, 3, 3, 1, 1, 1, 1, 3];

#Criando a sexta e ultima face
f6x = [1, 3, 3, 3, 3, 1, 1, 1];
f6y = [2, 2, 2, 0, 0, 0, 0, 2];
f6z = [1, 1, 1, 1, 1, 1, 1, 1];

#Desenha o cubo na posição inicial
figure(1);
plot3(15, 15, 15);
hold on
...
#Desenha o cubo com a primeira translação
figure(2);
plot3(15, 15, 15);
hold on

title('Exercício 1 - Primeira translação do cubo');
xlabel('EIXO X');
ylabel('EIXO Y');
zlabel('EIXO Z');

scatter3(pxt1, pyt1, pzt1, 'g');
...
#Desenha o cubo scalado
figure(3);
plot3(15, 15, 15);
hold on

title('Exercício 2 - Scalando o cubo');
xlabel('EIXO X');
ylabel('EIXO Y');
zlabel('EIXO Z');

scatter3(pxs1, pys1, pzs1, 'b');
...
title('Exercício 3 - Rotacionando o cubo no eixo Y');
xlabel('EIXO X');
ylabel('EIXO Y');
zlabel('EIXO Z');
...
#Desenha o cubo rotacionado e transladado
figure(5);
plot3(15, 15, 15);
hold on

title('Exercício 4 - Transladando o cubo rotacionando no eixo Y');
xlabel('EIXO X');
ylabel('EIXO Y');
zlabel('EIXO Z');

scatter3(pxt2, pyt2, pzt2, 'm');

plot3(f1t2x, f1t2y, f1t2z);
plot3(f2t2x, f2t2y, f2t2z);
plot3(f3t2x, f3t2y, f3t2z);
plot3(f4t2x, f4t2y, f4t2z);
plot3(f5t2x, f5t2y, f5t2z);
plot3(f6t2x, f6t2y, f6t2z);
